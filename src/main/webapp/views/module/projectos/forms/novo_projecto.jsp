   ...
   <div class="">
     ...
     <div class="form-group ">
      <label class="control-label requiredField" for="delegated">
        ...
        *
         ...
         <select class="select form-control"  id="inCharge" data-parsley-error-message="Selecione o Encaregado da Tarefa" required="" name="delegated" data-parsley-errors-container="#pls">
       <option value="">
           Selecione
       </option>
      </select>
     ...
     <div class="form-group">
                        ...
                        <div class="panel panel-default">
                                <div class="well">Integrantes da Equipa<span class="pull-right"><button class="btn btn-info" id="btn_add">Adicionar</button></span></div>
                                <div class="panel-body">


                                <table id="tbl_equipa" class="table-bordered dt-responsive" width="100%" border="1">
                                         <thead>
                                              <tr>
                                      ...
                                      <tbody>
                                          <c:forEach var="each" items="${task.team}">
                                              <tr data-member="${each.id}">
